...
public class AirlineCollection : IAirlineCollection
{
    ...
    static string[][] Data = new[]
    {
        ...
        new[] { "TA", "202", "TAI", "TACA International Airlines S.A.", "Avianca El Salvador", "TACA", "Transafrican" },
        ...
        new[] { "S8", "442", "AHW", "Sky Capital Airlines Limited dba Sky Air", "Sky Capital Airlines Ltd. - Bangladesh", "SkyAir", "Sky Capital" },
        ...
        new[] { "KW", "321", "BSC", "LLC Air company AeroStan dba LLC Air company AeroStan", "AeroStan Aircompany - Kyrgyzstan", "Aerostan", "Big Shot" },
        ...
        new[] { "WW", "313", "KXP", "M Jets International Sdn Bhd dba Kargo Xpress", "M Jets International Sdn Bhd t/a Kargo Xpress - Malaysia", "Kargo Xpress", "Xpress Kargo" },
        new[] { "GG", "576", "KYE", "Sky Lease I, Inc.", "Sky Lease 1, Inc. - United States of America", "Sky Lease Cargo", "Sky Cube" },
        new[] { "4L", "174", "LAU", "Lineas Aereas Suramericanas SA \"LAS S.A.\"", "Lineas Aereas Suramericanas SA t/a LAS, S.A. - Colombia", "LAS Cargo", "Suramericano" },
        new[] { "6T", "388", "LGT", "Longtail Aviation International Limited", "Longtail Aviation International Ltd - Bermuda", "Longtail Aviation", "Longtail" },
        new[] { "4X", "805", "MEC", "Mercury Air Cargo, Inc.", "Mercury Air Cargo, Inc. d/b/a Air Mercury - United States of America", "Mercury Aircourier Service", "Mercair" },
        new[] { "WD", "372", "MWM", "Modern Transporte Aereo de Carga SA dba Modern Logistics", "Modern Transporte Aereo De Carga S.A. d/b/a Modern Logistics - Brazil", "Modern Logistics", "Modernair" },
        new[] { "M2", "592", "MXS", "Sunrise Airlines Inc.", "Sunrise Airlines, Inc. d/b/a Millon Express - United States of America", "Millon Express", "Millon Express" },
        new[] { "S5", "917", "NKP", "Limited Liability Company \"Abakan A", "Abakan Air LLC - Russian Federation", "Abakan Air", "Abakan Air" },
        new[] { "2L", "901", "BOL", "Transportes Aereos Bolivianos", "Transportes Aereos Bolivianos", "Transportes Aéreos Bolivianos", "BOL" },
        new[] { "4S", "644", "OLC", "Solar Cargo, C.A.", "Solar Cargo, C.A. - Venezuela", "Solar Cargo", "Solarcargo" },
        new[] { "VZ", "863", "TVJ", "Thai Vietjet Air", "Thai Vietjet Air Joint Stock Co., Ltd. - Thailand", "Thai Vietjet Air", "Thaiviet Jet" },
        new[] { "YD", "259", "SYG", "Synergy Aviation Ltd", "Synergy Aviation Ltd. - United Kingdom", "Synergy Aviation", "Synergy" },
        new[] { "T7", "382", "TIW", "Transcarga Int'l Airways, C.A.", "Transcarga International Airways, C.A. - Venezuela", "Transcarga", "TIACA" },
        new[] { "4B", "210", "TUP", "Aviastar-TU Co. Aviacompany", "Aviastar-Tu Co. Ltd - Russian Federation", "Aviastar-Tu", "Tupolevair" },
        new[] { "TI", "768", "TWI", "Tailwind Hava Yollari A.S.", "Tailwind Hava Yollari A.S. - Turkey", "Tailwind Havayolları", "Tailwind" },
        new[] { "U7", "399", "UCG", "Uniworld Air Cargo Corp.", "Uniworld Commercial Group, S.A. (Uniworld Air Cargo) - Panama", "Uniworld Air Cargo", "Uniworld" },
        new[] { "ZK", "686", "ZAV", "Limited Liability Company \"Aircompa ZetAvia\" dba \"Aircompany ZetAvia\"", "Zetavia Limited, Aircompany - Ukraine", "Zetavia", "Zetavia" },

#if INCLUDE_UNCONFIRMED_AIRLINES
        ...
        new[] { "9I", "503", "LLR", "Airline Allied Services Limited dba Alliance Air", "Alliance Air - India", "Alliance Air", "Allied" },
        new[] { "KO*", "341", "KMA", "OJSC \"Komiaviatrans\"", "Komiaviatrans Open Joint Stock Company - Russian Federation", "", "Komi Avia" },
        new[] { "X8", "658", "MMX", "Airmax S.A.", "Airmax S.A. - Peru", "Airmax", "Perumax" },
        new[] { "7N", "007", "MTD", "MetroJets, LLC", "MetroJets, LLC - United States of America", "", "Matador" },
        new[] { "M2", "", "MHV", "MHS Aviation GmbH", "MHS Aviation GmbH - Germany", "MHS Aviation", "Snowcap" },
        new[] { "2L", "", "OAW", "Helvetic Airways AG", "Helvetic Airways AG - Switzerland", "Helvetic Airways", "Helvetic" },
        ...
        new[] { "S8", "", "SDA", "Sounds Air Travel and Tourism Ltd.", "Sounds Air Travel & Tourism Ltd. - New Zealand", "", "" },
        new[] { "N9", "", "SHA", "SHREE AIRLINES Pvt. Ltd.", "Shree Airlines Pvt. Ltd. - Nepal", "", "Shree-Air" },
        new[] { "SX", "906", "SRK", "Skywagon Corporation", "Skywork SA - Switzerland", "", "Skyfox" },
        new[] { "ZF", "925", "SXY", "Safari Express Cargo Ltd", "Safari Express Cargo Limited - Kenya", "", "Safari Express" },
        new[] { "TA", "400", "TAK", "Transafrican Air Limited dba Transafrican Air Ltd.", "Transafrican Air Limited - Kenya", "", "Transafrican" },
        new[] { "T7", "", "TJT", "Transcarga Int'l Airways, C.A.", "Twin Jet - France", "Twin Jet", "Twinjet" },
        new[] { "4B", "", "BTQ", "Boutique Air, Inc.", "Boutique Air, Inc. - United States of America", "", "Boutique" },
        new[] { "T8", "357", "TVR", "CA Terra Avia SRL", "CA Terra Avia S.r.l. - Moldova, Republic of", "", "Terraavia" },
        new[] { "V4", "", "VES", "Vieques Air Link, Inc", "Vieques Air Link, Inc. - Puerto Rico", "", "Vieques" },
        new[] { "4W", "", "WAV", "Warbelow's Air Ventures, Inc.", "Warbelow's Air Ventures, Inc. - United States of America", "", "Warbelow" },
        new[] { "8V", "", "WRF", "Wright Air Service Inc.", "Wright Air Service, Inc. - United States of America", "", "Wright Flyer" },
